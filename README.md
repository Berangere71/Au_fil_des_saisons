...
Application web de découverte et de gestion de recettes de saison, permettant aux utilisateurs de trouver des idées de plats selon les produits (fruits, légumes, viandes, poissons) disponibles à chaque période de l'année.
...
Le modèle relationnel repose sur trois entités centrales — **Recette**, **Produit** et **Saison** — reliées par des relations many-to-many, permettant à une recette d'appartenir à plusieurs saisons et de contenir plusieurs produits eux-mêmes disponibles sur plusieurs saisons.
